...
public class PreferredCustomer  extends Customer{
    ...
    public PreferredCustomer(String name, String address, String telephoneNumber, int customerNumber, boolean mailingList, int price, int discountLevel) {
    ...
    public String toString() {
        return "Customer Spent " + priceAmount + "\n" + "Discount Level " + discountLevel + "%";
    }
